...
void main(void) {
    ...
    //========== CLC2 DS interrupt falling edge ==========
    CLCSELECT = 1;      // select CLC2  

    CLCnSEL0 = 1;       // CLCIN1PPS <- DS
    CLCnSEL1 = 127;     // NC 
    CLCnSEL2 = 127;     // NC
    CLCnSEL3 = 127;     // NC

    CLCnGLS0 = 0x02;    // DS noninverted
    CLCnGLS1 = 0x04;    // 1(0 inverted) for AND gate
    CLCnGLS2 = 0x10;    // 1(0 inverted) for AND gate
    CLCnGLS3 = 0x40;    // 1(0 inverted) for AND gate
...
// 0x0000
  ...
  0x8c, 0xb6, 0xfc, 0xf0, 0x4c, 0x0c, 0x5c, 0x05, 0x7c, 0x41, 0x1c, 0x03, 0xcc, 0x02, 0x31, 0x10,
